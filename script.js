...
function performWikipediaSearch() {
    const query = document.getElementById('wikipediaSearchQuery').value;
    if (query) {
        const searchResultsContainer = document.getElementById('searchResultsContainer');
        searchResultsContainer.innerHTML = `<iframe src="https://en.wikipedia.org/wiki/Special:Search?search=${encodeURIComponent(query)}" width="100%" height="100%" frameborder="0"></iframe>`;
